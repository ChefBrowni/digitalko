<!DOCTYPE html>
    <html>
    <head>
        <title>Digitalko Törölt Termékek</title>
        <meta charset="utf-8">
        <!---LINK--->
  ...
  $sql1 ="SELECT * FROM asd
   ...
   OR gyarto LIKE :keyword
    ...
    $pagination_statement = $pdo_conn->prepare($sql1);
  ...
  <!---Lapozó--->
        <div class="form-group">
           <a href="inventory.php"><button class="btn btn-primary btn-lg">Vissza a fő oldalra</button></a>  
            <a href="inventorydel.php"><img src="img/sasa.jpg" width="205px" class="img-responsive center-block"></a>  
        </div>
        <div class="form-group">
          ...
          <form method="POST" class="form-group">
            ...
            <td><input type='submit' class='btn btn-warning  btn-lg' name="kihagy" value="Kihagy"></td>
             <td><input type='submit' class='btn btn-secondary btn-lg' name="torol" value="Töröl"></td>
                    ...
                    //Update Items
                        if(isset($_POST['feltolt'])){
                            ...
                            if ($mysqli->query($sql) === TRUE) {
                                echo '<script>window.location.href="inventorydel.php"</script>';
                            } else {
